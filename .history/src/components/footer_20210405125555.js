          ...
          <Row className="section-md">
            ...
            <Col className="footer-contact" lg="4" sm="6">
              ...
              <ul className="list-unstyled">
                ...
                <li className="my-2">
                  <List2 svg={<Pin />} value={satellite} />
                  Sawalag Dasmarinas, Cavite 4114'
                </li>
                <li className="my-2">
            ...
            <Col className="footer-soc" lg="4" sm="6">
              <div>
                <br></br>
              </div>
              ...
              <h6 className="font-weight-bold text-uppercase text-align-center d-flex justify-content-center">Get Social</h6>
