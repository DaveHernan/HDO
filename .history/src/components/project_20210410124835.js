...
const projCategories = ["all", "construction", "remodeling", "interior design", "proposed projects", "on-going projects"]
class Project extends Component {
  ...
  render() {
    ...
    return (
      <div className="project section-lg" id="projects">
        <Container>
          ...
          <section className="gallery-cat text-center">
            {projCategories.map((projCategory, index) => {
              return (
                <Badge
                  key={index}
                  color={projCategory === category ? "secondary" : "primary"}
