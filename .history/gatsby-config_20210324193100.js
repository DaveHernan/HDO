module.exports = {
  siteMetadata: {
    title: `HDO Building and Design`,
    fullTitle: `HDO Building and Design`,
    description: `Building Trust with Quality work.`,
    about: `Since our incorporation in 1981, we've grown from a regional organization to a multi-faceted, 
    national presence in the industry with headquarters in New York.`,
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        ...
        short_name: `starter`,
        start_url: `/`,
        background_color: `rgba(26,30,42,255)`,
        theme_color: `rgba(26,30,42,255)`,
        display: `minimal-ui`,
